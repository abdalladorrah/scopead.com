...
const translations = {
    ar: {
        ...
        cat_exec: 'العمليات',
        cat_market: 'الخدمات والسوق',

        // Items
        vision: 'رؤية المطعم',
        future_vision: 'خطط التوسع',
        master: 'الاستراتيجية العامة',
        competitors: 'المنافسون',

        plan: 'خطة العمل',
        budget: 'الميزانية',
        timeline: 'الجدول الزمني',
        checklist: 'قائمة التدشين',

        creatives: 'الإعلانات والعروض',
        persona: 'شخصيات العملاء',
        journey: 'رحلة العميل',
        retention: 'برامج الولاء',
    ...
    en: {
        ...
        cat_exec: 'Operations',
        cat_market: 'Services & Market',

        // Items
        vision: 'Restaurant Vision',
        future_vision: 'Expansion Plans',
        master: 'General Strategy',
...
const navItems = [
    ...
    // STRATEGY DROPDOWN
    {
        key: 'cat_strategy',
        children: [
            { key: 'master', href: 'strategy.html' }, // Strategy Page
    ...
    // MARKET/SERVICES DROPDOWN
    {
        key: 'cat_market',
        children: [
            { key: 'creatives', href: 'creatives.html' }, // Ad Creatives
    ...
    { key: 'guide', href: 'marketing_template.html' }
];
    ...
    <nav class="navbar">
        <div class="nav-container">
            <a href="index.html" class="nav-logo">
                ...
                <div class="logo-text">
                    <span class="brand-name" style="font-family: 'Inter', sans-serif;">Chindia</span>
                </div>
            </a>
...
function setLanguage(lang) {
    ...
    // Update Magic Hub if exists
    const hubText = document.getElementById('hub-lang-text');
    if (hubText) {
        hubText.innerText = lang === 'en' ? 'Arabic' : 'English';
    }
}
